...
#GUI Variables
$FormTitleText = "د ډیسک کلینر د جیم ټیلر (PowerShellEngineer.com) لخوا"
$SelectDiskLabelText = "ډیسک غوره کړئ:"
$FreeSpaceLabelText = "وړیا ځای (ګیګابایټ): "
$TotalSpaceLabelText = "ټول ځای (ګیګابایټ): "
$JunkFoundLabelText = "جنک موندل شوی (ګیګابایټ):"
$CleanDiskBtnText = "پاک ډیسک * فایلونه ړنګ کړئ*"
$SpaceCleanedLabelText = "پاک شوی ځای (ګیګابایټ):"
$LogFileLabelText = "د ننوتلو دوتنه وموندل شوه: $abcdefg"
$CreditLabelText = "د جیم ټیلر لخوا سکریپټ - PowerShellEngineer.com"
$LogFileLocatedText = "د ننوتلو دوتنه وموندل شوه"
$AnalyzingDriveText = "د ډرایو تحلیل..."
$BrowsersAreRunningText = "براوزرونه روان دي... کارونکي ته خبر ورکړئ..."
$PleaseCloseBrowsersText = "مهرباني وکړئ ټول ویب براوزرونه بند کړئ او بیا هڅه وکړئ."
$CleaningDriveText = "د ډرایو پاکول..."
